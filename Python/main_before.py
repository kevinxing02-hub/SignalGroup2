...
def main():
    ...
    #selected_features, selector_obj, diagnostics = select_features(features, labels, config, return_diagnostics=True)
# 如果暂时不需要 diagnostics，可以使用下划线忽略：
# selected_features, selector_obj, _ = select_features(features, labels, config, return_diagnostics=True)
